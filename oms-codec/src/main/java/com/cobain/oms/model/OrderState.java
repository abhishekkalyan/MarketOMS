...
public final class OrderState {
    ...
    /**
     * Total number of distinct states — sized to accommodate parent-only states.
     * Base states occupy 0–9. Parent-only states start at 10.
     * ParentOrderState.ROUTING = 10 requires index 10 in the transition table.
     */
